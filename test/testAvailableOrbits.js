...
describe('Available Orbits', function () {
  ...
  beforeEach(function () {
    ...
    star.companion = new Star(
      { stellarClass: 'V', stellarType: 'M', subtype: 6 },
      ORBIT_TYPES.COMPANION
    );
  ...
  it("if companion then minimum is 0.5 + companion's eccentricity", function () {
    ...
    star.companion = new Star(
      { stellarClass: 'V', stellarType: 'G', subtype: 0 },
      ORBIT_TYPES.COMPANION
    );
  ...
  it("mao is max of star's mao and companion's eccentricity + 0.5", function () {
    const star = new Star(
      { stellarClass: 'Ib', stellarType: 'A', subtype: 5 },
      ORBIT_TYPES.PRIMARY
    );
    star.companion = new Star(
      { stellarClass: 'V', stellarType: 'G', subtype: 0 },
  ...
  it('Near brown dwarf will not have any orbits', function () {
    const star = new Star(
      { stellarClass: '', stellarType: STELLAR_TYPES.BrownDwarf, subtype: null },
      ORBIT_TYPES.NEAR
    );
    star.orbit = 2.6;
