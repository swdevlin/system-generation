...
const cold3 = require("../atmosphere/cold3");
...
describe("tests for cold3 function", function () {
  ...
  it("if roll of 1 or 2 then atmosphere is Trace (code 1)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(1);
  ...
  it("if roll of 3 then atmosphere is Exotic (code 10)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(3);
    ROLL_CACHE.push(3);
    let planet = new TerrestrialPlanet(planetSize);
  ...
  it("if roll of 4 then atmosphere is Exotic (code 10), irritant", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(4);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
  ...
  it("if roll of 5 then atmosphere is Exotic (code 10)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(5);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
  ...
  it("if roll of 6 then atmosphere is Exotic (code 10)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(6);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
  ...
  it("if roll of 7 then atmosphere is Exotic (code 10)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(7);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
  ...
  it("if roll of 8 then atmosphere is Exotic (code 10)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(8);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
  ...
  it("if roll of 9 then atmosphere is Exotic (code 10), irritant", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(9);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
  ...
  it("if roll of 10 then atmosphere is Exotic (code 10)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(10);
    ROLL_CACHE.push(3);
    let planet = new TerrestrialPlanet(planetSize);
  ...
  it("if roll of 11 then atmosphere is Corrosive (code 11)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(11);
    ROLL_CACHE.push(3);
    ROLL_CACHE.push(3);
  ...
  it("if roll of 12 then atmosphere is Insidious (code 12)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(12);
    ROLL_CACHE.push(3);
    ROLL_CACHE.push(3);
  ...
  it("if roll of 13 then atmosphere is Gas, Helium (code 16)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(13);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
  ...
  it("if roll of 14 then atmosphere is Gas, Hydrogen (code 17)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(14);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
  ...
  it("if roll of 16 then atmosphere is Gas, Hydrogen (code 17)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(16);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
  ...
  it("if roll of 17 then atmosphere is Gas, Hydrogen (code 17)", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(17);
    let planet = new TerrestrialPlanet(planetSize);
    cold3(star, planet);
