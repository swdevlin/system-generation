...
const {cold1} = require('../atmosphere');
...
describe("tests for cold1 function", function () {
  ...
  it("if roll <= size then atmosphere is none", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(0);
    const atmosphere = cold1(0, planetSize);
  ...
  it("if roll of 1 or 2 then atmosphere is 1", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(1);
    let atmosphere = cold1(0, planetSize);
  ...
  it("if roll of 13 then atmosphere is 13", function() {
    ...
    ROLL_CACHE.push(13);
    let atmosphere = cold1(0, planetSize);
    atmosphere.code.should.equal(13);
    atmosphere.characteristic.should.equal('');
    atmosphere.irritant.should.be.false;
  });

  it("if roll of 14 then atmosphere is 11", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(14);
    let atmosphere = cold1(0, planetSize);
    atmosphere.code.should.equal(11);
  ...
  it("if roll of 16 then atmosphere is 16", function() {
    ROLL_CACHE.push(0);
    ROLL_CACHE.push(16);
    let atmosphere = cold1(0, planetSize);
