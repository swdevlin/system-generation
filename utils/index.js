...
module.exports.periapsisTemperature = require('./meanTemperature').periapsisTemperature;
module.exports.apoapsisTemperature = require('./meanTemperature').apoapsisTemperature;
